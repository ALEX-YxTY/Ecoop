...
public class CitycodeUtil {
	...
	public ArrayList<String> getProvince(List<City> provice) {
	...
	public ArrayList<String> getCity(
			HashMap<String, List<City>> cityHashMap, String provicecode) {
	...
	public ArrayList<String> getCouny(
			HashMap<String, List<City>> cityHashMap, String citycode) {
		System.out.println("citycode" + citycode);
		List<City> couny = null;
